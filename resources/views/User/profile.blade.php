  ...
  <div class="row">
    {{-- <div class="col-sm-3">&nbsp;</div> --}}
      ...
      <div class="text-center">
        ...
        <img  src="{{asset('storage/img/users/'.$user['image'])}}" class="avatar img-circle img-thumbnail" id="img" alt="avatar">
      </div></hr><br>
    </div><!--/col-3-->
    ...
    <div class="col-sm-6">
      ...
      <div class="tab-content">
        <div class="tab-pane active"id="user_information" >
          ...
          <form class="form" action="#" method="post"  >
            <ul class="list-group">
              ...
              <li class="list-group-item text-right"><span class="pull-left"><strong>Referral Code</strong></span>{{$user['referral_id']}}</li>
              <li class="list-group-item text-right"><span class="pull-left"><strong>Email</strong></span>{{$user['email']}}</li>
              <li class="list-group-item text-right"><span class="pull-left"><strong>Contact</strong></span>{{!empty($user['contact'])?$user['contact']:" - "}}</li>
            </ul> 
            <div class="form-group">
              <div class="col-xs-12">
                <br>
                <a class="btn btn-lg btn-primary" href="{{route('user.profile.edit')}}">Edit</a>
        ...
        <div class="tab-pane" id="change_password">   
          <h2></h2>  
          <hr>
          <form class="form" action="{{route('user.password.change')}}" method="post">
            @csrf
            <div class="form-group">
              <div class="col-xs-12">
