            ...
            <hr>
              ...
              <ul class="list-group">
                ...
                <li class="list-group-item text-right"><span class="pull-left"><strong>Contact</strong></span>
                  <input type="text" name="contact" placeholder="Active Whatsapp number" class="" value="{{$user['contact']}}">
                  @error('contact')
                  <br>
                  <span class="text-danger">{{ $message }}</span>
              @enderror
              ...
              <div class="form-group">
                <div class="col-xs-12">
                  ...
                  <a class="btn btn-lg btn-danger" href="{{route('user.profile')}}">Cancel</a>
